...
export function document(page) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="A fictional portfolio prototype exploring research, teaching, photography and virtual worlds."><meta name="color-scheme" content="${creative ? 'dark' : 'light'}"><title>${page.title} — Your Name / Fieldnotes</title><link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="/styles.css"></head><body class="${creative ? 'creative-theme' : ''}"><a class="skip-link" href="#main">Skip to content</a><div class="site-wrap"><header class="site-header"><a class="identity" href="/" ${page.path === '/' ? 'aria-current="page"' : ''}><span class="monogram" aria-hidden="true">yn<span>↗</span></span><span>Your Name<span class="identity-caption">Researcher & maker</span></span></a><nav aria-label="Main navigation">${navigation.map(([label, href]) => `<a href="${href}" ${page.path === href ? 'aria-current="page"' : page.path.startsWith(href) ? 'class="active-section"' : ''}>${label}</a>`).join('')}</nav></header><main id="main" tabindex="-1">${page.content}</main><footer class="site-footer"><div><a class="footer-name" href="/">Your Name <span aria-hidden="true">↗</span></a><p>Research, practice, and everything in between.</p></div><div class="footer-note"><span>Fieldnotes / Portfolio study 01</span><span>Fictional content · Geometric image placeholders</span></div></footer></div></body></html>`;
}
